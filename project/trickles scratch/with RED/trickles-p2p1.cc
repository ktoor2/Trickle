...
int main(int argc, char *argv[])
{
    ...
    std::string tracename = "traceRed.tr";
    ...
    std::cout << "Output file: " << tracename << std::endl;
		//int queueint = std::atoi(queue.c_str());
    ...
    Config::SetDefault("ns3::TricklesSocket::SegmentSize", UintegerValue (segment));
  	...
  	Config::SetDefault ("ns3::RedQueue::MeanPktSize", UintegerValue (5000));
  	...
  	Config::SetDefault ("ns3::RedQueue::MinTh", DoubleValue (queue/3));
  	Config::SetDefault ("ns3::RedQueue::MaxTh", DoubleValue ((queue/3)*2));
  	Config::SetDefault ("ns3::RedQueue::QueueLimit", UintegerValue (queue));
    ...
    */
    ...
    p2p.SetChannelAttribute ("Delay",  TimeValue (MilliSeconds(delay)));
		p2p.SetQueue ("ns3::RedQueue", 
                "LinkBandwidth", StringValue (bandwidth0),
                "LinkDelay",TimeValue (MilliSeconds(delay)));
